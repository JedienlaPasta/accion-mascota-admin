    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50">
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
        ...
        <p className="mb-6 text-sm text-gray-500">
          ¿Estás seguro de que deseas {content.toLowerCase()} esta atención?
        ...
        <div className="flex justify-end space-x-4">
          <button
            ...
            className={`cursor-pointer rounded-md bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 transition-transform focus:scale-95 ${isDisabled ? 'cursor-not-allowed' : 'hover:bg-gray-200'}`}
          >
            Cancelar
          </button>
          <button
